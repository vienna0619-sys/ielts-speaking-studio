...
export function createExaminerProfile({
  ...
  // Appearance and voice are deliberately selected independently. A face or
  // skin tone must never be used as a proxy for a regional English accent.
  const avatarPool = EXAMINER_AVATARS.filter((avatar) => avatar.enabled);
