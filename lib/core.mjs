...
export const EXAMINER_VOICE_PRESETS = [
  {
    ...
    verifiedGenderPresentation: "female",
    speakingRate: 0.98,
    pitch: 1,
    volume: 1,
    qualityLevel: "high",
  ...
  },
  {
    ...
    verifiedGenderPresentation: "male",
    speakingRate: 0.98,
    pitch: 1,
    volume: 1,
    qualityLevel: "high",
  ...
  },
  {
    ...
    locale: "en-US",
    genderPresentation: "male",
    verifiedGenderPresentation: null,
    speakingRate: 0.99,
    pitch: 1,
    volume: 1,
    qualityLevel: "unverified",
    qualityStatus: "disabled-unverified-gender",
    enabled: false,
    supportedModes: ["mock-exam", "practice"],
  ...
  },
  {
    ...
    volume: 1,
    qualityLevel: "unverified",
    qualityStatus: "disabled-unverified-accent",
    enabled: false,
    supportedModes: ["mock-exam", "practice"],
  ...
  },
  {
    ...
    volume: 1,
    qualityLevel: "unverified",
    qualityStatus: "disabled-unverified-gender-accent",
    enabled: false,
    supportedModes: ["mock-exam", "practice"],
  ...
  },
  {
    ...
    volume: 1,
    qualityLevel: "unverified",
    qualityStatus: "disabled-quality",
    enabled: false,
    supportedModes: ["mock-exam", "practice"],
  ...
  },
  {
    ...
    volume: 1,
    qualityLevel: "unverified",
    qualityStatus: "disabled-quality-and-gender",
    enabled: false,
    supportedModes: ["mock-exam", "practice"],
...
export const EXAMINER_AVATARS = [
  {
    ...
    appearanceProfile: "east-asian-adult",
    genderPresentation: "female",
    estimatedAgeRange: "38–48",
    appearanceCategory: "east-asian",
    spriteRow: 0,
    enabled: true,
  },
  {
    id: "arjun",
    displayName: "Examiner A.",
    appearanceProfile: "south-asian-adult",
    genderPresentation: "male",
    estimatedAgeRange: "40–52",
    appearanceCategory: "south-asian",
    spriteRow: 1,
    enabled: true,
  },
  {
    id: "nadia",
    displayName: "Examiner N.",
    appearanceProfile: "black-adult",
    genderPresentation: "female",
    estimatedAgeRange: "45–58",
    appearanceCategory: "black",
    spriteRow: 2,
    enabled: true,
  },
  {
    id: "james",
    displayName: "Examiner J.",
    appearanceProfile: "white-adult",
    genderPresentation: "male",
    estimatedAgeRange: "40–52",
    appearanceCategory: "white",
    spriteRow: 3,
    enabled: true,
  },
];
...
export function createExaminerProfile({
  ...
  let voice;
  if (!randomEnabled) {
    const configured = EXAMINER_VOICE_PRESETS.find(
      (candidate) => candidate.id === fixedVoiceId,
    );
    const requested =
      enabledVoices.find((candidate) => candidate.id === fixedVoiceId) ||
      enabledVoices.find(
        (candidate) =>
          candidate.genderPresentation === configured?.genderPresentation &&
  ...
  // Appearance and accent remain independent, but the presentation gender is
  // validated before a session starts so a male/female appearance cannot
  // silently receive an opposite-gender fallback voice.
  ...
  return {
    ...
    requestedVoiceId: randomEnabled ? voice.id : fixedVoiceId,
    voiceId: voice.id,
    accent: voice.accent,
    locale: voice.locale,
    genderPresentation: avatar.genderPresentation,
    verifiedGenderPresentation: voice.verifiedGenderPresentation,
    estimatedAgeRange: avatar.estimatedAgeRange,
    speakingRate: voice.speakingRate,
    pitch: voice.pitch,
    volume: voice.volume,
    qualityLevel: voice.qualityLevel,
    qualityStatus: voice.qualityStatus,
    enabled: true,
    supportedModes: [...voice.supportedModes],
    fallbackVoiceId: voice.fallbackVoiceId,
    selectedAt: new Date().toISOString(),
    fallbackReason:
      randomEnabled || voice.id === fixedVoiceId
        ? null
        : "requested-voice-disabled-or-unverified",
    locked: true,
